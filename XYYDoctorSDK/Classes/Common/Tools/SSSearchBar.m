...
- (void)layoutSubviews {
    ...
    // 设置背景图片
    UIImage *backImage = [UIImage imageWithColor:[UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1]];
    ...
    for (UIView *view in [self.subviews lastObject].subviews) {
        if ([view isKindOfClass:[UITextField class]]) {
            ...
            [field setBackgroundColor:RGB(238, 238, 238)];
            ...
            // 设置占位文字字体颜色
            [field setValue:[UIColor colorWithRed:153/255.0 green:153/255.0 blue:153/255.0 alpha:1] forKeyPath:@"_placeholderLabel.textColor"];
            [field setValue:[UIFont systemFontOfSize:placeHolderFont] forKeyPath:@"_placeholderLabel.font"];
//            [self setImage:[UIImage imageNamed:@"yx_search"] forSearchBarIcon:UISearchBarIconSearch state:UIControlStateNormal];
            field.leftView=[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"yx_search"]];
            //field.leftView.
