...
- (void)reloadDataWithModel:(DoctorprescriptiontraceModel *)model{
    ...
    if (model.operateContent) {
        _labShuoming.text=[NSString stringWithFormat:@"%@%@ %@",model.operator,model.operateNodeDescription,model.operateContent];
    }else{
