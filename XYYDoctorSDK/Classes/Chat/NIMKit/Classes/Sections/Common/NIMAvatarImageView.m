...
- (void)setAvatarBySession:(NIMSession *)session
{
    ...
    [self nim_setImageWithURL:url placeholderImage:[UIImage XYY_imageInKit:@"mess_left"]];
}
...
- (void)setAvatarByMessage:(NIMMessage *)message
{
    ...
    //修改头像了
    NIMUser *me    = [[NIMSDK sharedSDK].userManager userInfo:message.from];
    NSString *str;
    if (message.from == [[NIMSDK sharedSDK] .loginManager currentAccount]) {
        str = @"mess_right";
    }else{
        str = @"mess_left";
    }
    NSURL *url = me.userInfo.avatarUrl ? [NSURL URLWithString:me.userInfo.avatarUrl] : nil;
    
    [self nim_setImageWithURL:url placeholderImage:[UIImage XYY_imageInKit:str]];
}
