...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [_voiceButton setImage:[UIImage XYY_imageInKit:@"voice"] forState:UIControlStateNormal];//修改语音图标
        [_voiceButton setImage:[UIImage XYY_imageInKit:@"voice"] forState:UIControlStateHighlighted];
        ...
        _inputTextView.layer.borderColor = UIColorFromRGB(0xD9D9D9).CGColor;
        ...
        _bottomSep.backgroundColor = UIColorFromRGB(0xD9D9D9);
...
{
    [self.voiceButton setImage:selected?[UIImage XYY_imageInKit:@"voice"]:[UIImage nim_imageInKit:@"icon_toolview_keyboard_normal"] forState:UIControlStateNormal];
    [self.voiceButton setImage:selected?[UIImage XYY_imageInKit:@"voice"]:[UIImage nim_imageInKit:@"icon_toolview_keyboard_pressed"] forState:UIControlStateHighlighted];
}
