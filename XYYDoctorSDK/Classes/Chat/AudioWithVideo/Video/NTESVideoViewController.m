...
- (void)setupRightNavItem
{
    ...
    [button setImage:[ImageUtil getImageByPatch:@"icon_gallery_more_normal"] forState:UIControlStateNormal];
    [button setImage:[ImageUtil getImageByPatch:@"icon_gallery_more_pressed"] forState:UIControlStateHighlighted];
    [button sizeToFit];
...
//            [SVProgressHUD showProgress:progress];
        ...
        if (wself) {
            [MBProgressHUD hideAllHUDsForView:wself.view animated:NO];
            if (handler) {
                handler(error);
            }
        }
