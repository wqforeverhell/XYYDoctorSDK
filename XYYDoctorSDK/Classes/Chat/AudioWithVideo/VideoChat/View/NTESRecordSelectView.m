...
-(instancetype)initWithFrame:(CGRect)frame Video:(BOOL)isVideo
{
    if (self = [super initWithFrame:frame]) {
        ...
        [_audioConversation setImage:[ImageUtil getImageByPatch:@"record_not_selected"] forState:UIControlStateNormal];
        [_audioConversation setImage:[ImageUtil getImageByPatch:@"record_selected"] forState:UIControlStateSelected];
        [self addSubview:_audioConversation];
        [_audioConversation sizeToFit];

        //myMediaButton
        _myMediaButton = [UIButton buttonWithType:UIButtonTypeCustom];
        [_myMediaButton setImage:[ImageUtil getImageByPatch:@"record_not_selected"] forState:UIControlStateNormal];
        [_myMediaButton setImage:[ImageUtil getImageByPatch:@"record_selected"] forState:UIControlStateSelected];
        ...
        [_otherSideMediaButton setImage:[ImageUtil getImageByPatch:@"record_not_selected"] forState:UIControlStateNormal];
        [_otherSideMediaButton setImage:[ImageUtil getImageByPatch:@"record_selected"] forState:UIControlStateSelected];
